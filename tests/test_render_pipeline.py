...
def test_sample_provenance_banner_modes() -> None:
    ...
    sourced = rp.render(SAMPLE, back_href="index.html", source="/p/.forge/runs/r.jsonl")
...
def test_xss_in_task_and_tool_target_escaped() -> None:
    ...
    out = rp.render(
        _trace(
            ...
            {
                "ts": "2026-07-18T08:00:03+00:00",
                "event": "blocker",
                "blocker_id": xss,
                "count": 1,
            },
            {
                "ts": "2026-07-18T08:00:04+00:00",
                "event": "escalate",
                "to": xss,
                "reason": xss,
            },
